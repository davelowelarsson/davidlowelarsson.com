...
Branch protection and auto-merge are gated on private repos. On the free plan, a private
...
Dependabot doesn't read your Actions secrets. Workflows triggered by Dependabot PRs get
...
**Takeaway:** branch protection on GitHub free requires a public repo, and Dependabot reads from its own secrets store, not yours.
