...
I tried a small version of that in an [AI factory experiment](/posts/experiment-ai-factory-in-a-day/),
where the things I could actually own were the instruments and the gates.
